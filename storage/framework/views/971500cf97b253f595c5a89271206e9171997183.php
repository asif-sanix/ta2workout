    ...
    <div class="card-content">
        <div class="card-body">
            ...
            <div class="row my-1">
                ...
                <?php echo Form::open(['method' => 'POST', 'route' => 'admin.category.store', 'class' => 'form-horizontal','files'=>true]); ?>

                       
                     <div class="row my-1">
                        <div class="col-lg-7 col-7">

                            <input type="hidden" name="parent" value="<?php echo e((@$category->parent)?@$category->parent:@$category->id); ?>">
                            <input type="hidden" name="id" value="<?php echo e(@$category->id); ?>">

                            <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                                    <?php echo Form::label('name', 'Category Name'); ?>

                                    <?php echo Form::text('name', null, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Category']); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ta2workout/resources/views/admin/category/create.blade.php ENDPATH**/ ?>