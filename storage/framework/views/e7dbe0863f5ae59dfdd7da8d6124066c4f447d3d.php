        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="/admin">
              ...
              <h3 class="brand-text"><?php echo e(\App\Model\SiteSetting::latest()->value('site_title')); ?></h3>
            </a>
          </li>
...
</nav><?php /**PATH /var/www/html/ta2workout/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>