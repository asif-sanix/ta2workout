<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo e(asset(\App\Model\SiteSetting::latest()->value('logo'))); ?>" rel="icon">
  <link href="<?php echo e(asset(\App\Model\SiteSetting::latest()->value('logo'))); ?>" rel="apple-touch-icon">
  ...
  <link href="<?php echo e(asset('web/css/developer.css')); ?>" rel="stylesheet">
</head><?php /**PATH /var/www/html/ta2workout/resources/views/web/layouts/head.blade.php ENDPATH**/ ?>