     ...
     <div class="row my-1">
                <div class="col-lg-7 col-7">
                        ...
                        <div class="form-group<?php echo e($errors->has('sub_title') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::text('sub_title', $slider->sub_title, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Sub title']); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('button_text') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::text('button_text', $slider->button_text, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Text On Button']); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('button_link') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::text('button_link', $slider->button_link, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Link On Button']); ?>

                            <small class="text-danger"><?php echo e($errors->first('button_link')); ?></small>
                        </div>
                    
                        <div class="btn-group">
                            <?php echo Form::submit("Update Slider", ['class' => 'btn btn-info']); ?>
                ...
                <div class="col-lg-5 col-5">
                    ...
                    <div class="form-group">
                        <div class="checkbox<?php echo e($errors->has('status') ? ' has-error' : ''); ?>">
                            <?php echo Form::label('status', 'Status'); ?><br>
                             <?php echo Form::checkbox('status', '1', $slider->status, ['id' => 'switch1','class'=>'switch']); ?> 
                        </div>
                  ...
                  <div class="form-group <?php echo e($errors->has('image') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::file('image', ['class'=>'dropify','data-default-file'=>asset(@$slider->image)]); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ta2workout/resources/views/admin/slider/edit.blade.php ENDPATH**/ ?>