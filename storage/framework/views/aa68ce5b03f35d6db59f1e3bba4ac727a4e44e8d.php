...
<div class="card">
    <div class="card-content">
        <div class="card-body">
          <?php echo Form::open(['route'=>['admin.'.request()->segment(2).'.update',$post->id],'method'=>'put','files'=>true]); ?>
            ...
            <div class="row my-1">
                <div class="col-lg-7 col-7">
                        ...
                        <div class="form-group<?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::text('title', $post->title, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Post Title']); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('subtitle') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::text('subtitle', $post->subtitle, ['class' => 'form-control', 'required' => 'required','placeholder'=>'Post Subtitle']); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('body') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::textarea('body', $post->body, ['class' => 'form-control summernote', 'required' => 'required']); ?>
                ...
                <div class="col-lg-5 col-5">
                    ...
                    <div class="form-group">
                        <div class="checkbox<?php echo e($errors->has('status') ? ' has-error' : ''); ?>">
                            <?php echo Form::label('status', 'Status'); ?><br>
                             <?php echo Form::checkbox('status', '1', $post->status, ['id' => 'switch1','class'=>'switch']); ?> 
                        </div>
                    ...
                    <div class="form-group <?php echo e($errors->has('image') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::file('image', ['class'=>'dropify','data-default-file'=>@$post->image]); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sanixnew/resources/views/admin/post/edit.blade.php ENDPATH**/ ?>