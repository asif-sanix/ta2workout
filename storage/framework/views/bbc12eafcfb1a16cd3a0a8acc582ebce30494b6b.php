...
<head>
  ...
  <link rel="apple-touch-icon" href="<?php echo e(asset(\App\Model\SiteSetting::latest()->value('favicon'))); ?>">
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset(\App\Model\SiteSetting::latest()->value('favicon'))); ?>">
          ...
          <div class="card border-grey border-lighten-3 px-2 py-2 row mb-0">
            ...
            <div class="card-header border-0" style="padding: 0">
              <div class="card-title text-center">
                <img style="max-height: 65px;" src="<?php echo e(asset(\App\Model\SiteSetting::latest()->value('logo'))); ?>" alt="branding logo">
              </div>
...
</html><?php /**PATH /var/www/html/ta2workout/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>