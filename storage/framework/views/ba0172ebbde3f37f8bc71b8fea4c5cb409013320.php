                    ...
                    { "data": "created_at" }, 
                    {
                        ...
                        render: function(data, type, row) {
                            if (type === 'display') {
                                ...
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', 'edit_post')): ?>
                                ...
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', 'delete_post')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ta2workout/resources/views/admin/post/list.blade.php ENDPATH**/ ?>