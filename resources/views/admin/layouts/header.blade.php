        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="/admin">
              <img style="max-height:30px;" class="brand-logo" alt="stack admin logo" src="{{\App\Model\SiteSetting::latest()->value('logo')}}">
              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="rounded img-fluid mb-1" src="{{asset('admin-assets/app-assets/images/slider/slider-2.png')}}"
